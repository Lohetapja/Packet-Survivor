...
(function (CDL) {
  ...
  // Pick 3 distinct, currently-valid upgrades for a level-up.
  CDL.buildChoices = function () {
    const valid = CDL.UPGRADES.filter((u) => u.available(CDL.S.player.tools));
    CDL.shuffle(valid);
